...
const stateParkUL = document.getElementById("state-parks-texas");
stateParkUL.parentElement.style.backgroundColor = "lightblue"
...
for(let i = 0; i < stateParksLIs.length; i++) {
    ...
    stateParksLIs[4].style.fontSize = "20px"
}
...
const nationParkHeading = document.querySelector('#national-parks-heading');
nationParkHeading.nextElementSibling.style.background = 'salmon'